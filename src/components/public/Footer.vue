<template>
    <el-footer class="layout-footer-container">
        <!-- 认证 -->
        <div class="layout-footer-brank" :class="{active: state==2,active1: state==3,active2: state==4,active3: state==1}">
        ...
        <!-- 微信二维码 -->
        <div class="layout-footer-wx" :class="{active: state==2,active1: state==3,active2: state==4,active3: state==1}">
            <div class="container wx-container">
                <div class="wx" :class="{active: state==2 || state==3|| state==4|| state==1}">
                    <div>
                        <span>手机购药</span>
                ...
                <div class="wx-sm" :class="{active: state==2 || state==3|| state==4|| state==1}">
                    <ul class="wx-sm-box">
