<template>
	<footer class="layout-footer-container">
		...
		<ul class="container flex layout-footer-government link">
			<li><b>政府机构:</b></li>
			<li v-for="item in governmentLink" :key="item.id"><a :href="item.url" target="_blank" v-text="item.name"></a></li>
		</ul>
		<ul class="container flex layout-footer-link link">
			<li><b>友情链接:</b></li>
			<li v-for="item in link" :key="item.id"><a :href="item.url" target="_blank" v-text="item.name"></a></li>
		</ul>
