<template>
  <div class="details-box">
    ...
    <p class="image-text-title"><span>图文详情</span></p>
    <div class="datails-img-box">
        <img :src="item" alt="img" v-for="item in tabList.imgList" :key="item.id">
    </div>
    <div class="questionAndAnswer">
        <P class="questionAndAnswer-title"><span>商品问答</span>预定前如有疑问，可在下方留言咨询：或拨打免长途热线<span>400-8811-000</span></P>
        <ul class="questionAndAnswer-sub">
            <li class="questionAndAnswer-item" v-for="item in interlocutionList" :key="item.id">
                ...
                <p>药居士药师<span>{{item.answerTime}}</span></p>
            </li>
        </ul>
        <p class="want-ask"><span>我要提问</span></p>
  ...
  data() {
    return {
      ...
      tabList: {
        ...
        Usage: "详见说明书",
        AdverseReaction: "可能出现的主要不良反应为皮肤剌激性，减少用...",
        imgList: [
